...
def play_game(li, game_id, control_queue, engine_factory, user_profile, config, challenge_queue, correspondence_queue, logging_queue, logging_configurer, logging_level):
    ...
    conversation.send_reply(SendLine('player'), f'Hello! This is a bot created by @Heroreborn_Utsa0! All the best {opponent} 😁 !')
    conversation.send_reply(SendLine('player'), f'Good luck have fun!:D')
