...
class Conversation: 
    ...
    def command(self, line, game, cmd):
        if cmd == "commands" or cmd == "help":
            self.send_reply(line, "Supported commands: !wait, !name, !howto, !eval, !queue, !Favourite variant")
            ...
            self.send_reply(line, "How to run your own bot: Check out 'github.com/SriMethan/Lichess-Bot-Heroku")
